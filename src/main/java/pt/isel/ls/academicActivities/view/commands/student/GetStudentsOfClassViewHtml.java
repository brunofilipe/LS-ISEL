...
public class GetStudentsOfClassViewHtml implements Writable{
    private List<Student> students;

    public GetStudentsOfClassViewHtml (List<IEntity> students){
    ...
    public void writeTo(Writer w) throws IOException {
        ...
        String header = "Existing students  that belong to the class given in the parameters :  ";
